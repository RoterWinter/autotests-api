...
Данный пример наглядно показывает:
    ...
    Какие скоупы фикстур могут быть
    Какие скоупы фикстур чаще всего используются
    В каких случаях, могут быть использованы те или иные скоупы
    Также показывает, как правильно объявлять и использовать фикстуры в автотестах
'''
